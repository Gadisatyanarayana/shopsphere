  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center space-y-4">
        ...
        <p className="text-xs text-slate-400">Log in to view your saved wishlist items.</p>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      <div className="border-b border-slate-800 pb-6">
        ...
        <p className="text-xs text-slate-400 mt-1">Your personal collection of saved products</p>
      </div>
      ...
      {products.length > 0 ? (
        ...
        <div className="glass-panel p-12 text-center rounded-3xl space-y-4 border border-slate-800">
          ...
          <p className="text-xs text-slate-400 max-w-sm mx-auto">Save items you love while browsing to buy them later.</p>
